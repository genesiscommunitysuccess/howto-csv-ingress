...
Find [full documentation on Data Pipelines](https://learn.genesis.global/docs/server/data-pipelines/introduction/)
...
- Add `implementation("global.genesis:genesis-notify-pipelines:${properties["genesis-notifyVersion"]}")` to `<project>-app/src/build.gradle.kts`
